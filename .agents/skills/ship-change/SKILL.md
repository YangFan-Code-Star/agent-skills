...
任务里出现过四种信号中的任何一种——**我一开始理解错了什么 / 用户纠正了我什么 / 我花了超过 20 分钟才搞清什么 / 同一个流程或概念被解释了 2 次以上**——就往项目根目录的 `docs/learning-inbox.md` 追加一条。每种信号对应的类型、去向和条目格式都写在那个文件里，追加时必然要打开它，这里不重复一份。
